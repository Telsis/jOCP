 ...
 * Resource} message. This message tells the fastSCP that the call-handling
 * platform is attempting to connect to the external resource.
 * <p/>
 ...
 * <td>destLegID</td>
 * <td>2</td>
 * <td>This is the leg ID that is being connected</td>
 * </tr>
 * <tr>
 * <td>spare</td>
 * <td>1</td>
 ...
 * @author Telsis
 */
public class ConnectToResourceAck extends CallControlMessage {
    /** The message type. */
    public static final LegacyOCPMessageTypes TYPE = LegacyOCPMessageTypes.CONNECT_TO_RESOURCE_ACK;
    ...
    /**
     * Decode the buffer into a Connect To Resource Ack message.
     *
     * @param buffer
     ...
     */
    public ConnectToResourceAck(final ByteBuffer buffer) throws OCPException {
        super(buffer);
    ...
    /**
     * Instantiates a new Connect To Resource Ack message.
     */
    public ConnectToResourceAck() {
    ...
    public final String toString() {
        return "Connect to Resource Ack";
    }
